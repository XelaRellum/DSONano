...
{  
  switch (Item_Index[1]) {
    case  0  :  TIM2_CCR4 =((240-Y0)*20)/32 +881;  break; 
    case  1  :  TIM2_CCR4 =((240-Y0)*42)/32 +799;  break; 
    case  2  :  TIM2_CCR4 =((240-Y0)*104)/32+566;  break; 
    case  3  :  TIM2_CCR4 =((240-Y0)*207)/32+180;  break; 
    
    case  4  :  TIM2_CCR4 =((240-Y0)*55)/32 +750;  break; 
    case  5  :  TIM2_CCR4 =((240-Y0)*138)/32+439;  break; 
    case  6  :  TIM2_CCR4 =((240-Y0)*275)/32-75;   break; 

    case  7  :  TIM2_CCR4 =((240-Y0)*53)/32 +758;  break; 
    case  8  :  TIM2_CCR4 =((240-Y0)*132)/32+461;  break; 
    case  9  :  TIM2_CCR4 =((240-Y0)*265)/32-37;   break; 
    
    case  10 :  TIM2_CCR4 =((240-Y0)*42)/32 +799;  break; 
    case  11 :  TIM2_CCR4 =((240-Y0)*105)/32+563;  break; 
    case  12 :  TIM2_CCR4 =((240-Y0)*212)/32+161;  break; 
    
    case  13 :  TIM2_CCR4 =((240-Y0)*57)/32 +743;  break; 
    case  14 :  TIM2_CCR4 =((240-Y0)*142)/32+424;  break; 
    case  15 :  TIM2_CCR4 =((240-Y0)*284)/32-109;  break; 
    
    case  16 :  TIM2_CCR4 =((240-Y0)*59)/32 +735;  break; 
    case  17 :  TIM2_CCR4 =((240-Y0)*146)/32+409;  break; 
    case  18 :  TIM2_CCR4 =((240-Y0)*294)/32-146;  break;    
    
    default  :  TIM2_CCR4 =956; break;
  }
}
/*******************************************************************************
 Detect USB ON
